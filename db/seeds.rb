...
comment1_1 = Comment.create( topic_id: topic2.id, user_id: user1.id, parent: comment1.id, body: 'How rude' )
comment2 = Comment.create( topic_id: topic1.id, user_id: user1.id, body: 'This is a great election cycle')
comment2_2 = Comment.create( topic_id: topic1.id, user_id: user3.id, parent: comment2.id, body: 'I respectfully disagree')